...
```bash
uds zarf deploy oci://ghcr.io/defenseunicorns/packages/uds/uds-runtime:<tag> --confirm
```
...
```bash
uds zarf deploy oci://ghcr.io/defenseunicorns/packages/uds/uds-runtime:nightly-unstable
```
