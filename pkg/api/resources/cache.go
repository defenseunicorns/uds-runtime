...
import (
	...
	"github.com/defenseunicorns/uds-engine/pkg/api/resources/workloads"
...
type Cache struct {
	...
	Events       *workloads.ResourceList[*v1.Event]
...
func NewCache(ctx context.Context) (*Cache, error) {
	...
	c.Events = workloads.NewResourceList[*v1.Event](factory.Core().V1().Events().Informer())
